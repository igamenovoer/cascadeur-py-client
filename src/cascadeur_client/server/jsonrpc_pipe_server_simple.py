"""
JSON-RPC 2.0 Server using Named Pipes (Simplified Version)

This module implements a simplified JSON-RPC 2.0 server that communicates through
named pipes (Windows) or Unix domain sockets (Linux/macOS) with proper Ctrl+C handling.
"""
...
class JSONRPCPipeServer:
    ...
    Simplified version with better Ctrl+C handling.
    """
    ...
    def start(self) -> None:
        ...
        def signal_handler(signum, frame):
            ...
            # Create a dummy connection to unblock accept() on Windows
            if os.name == 'nt' and self.listener:
                try:
